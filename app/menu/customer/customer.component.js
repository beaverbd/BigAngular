...
var CustomerComponent = (function () {
    function CustomerComponent(dataPeekerService, financeservice, accountService) {
        var _this = this;
    ...
    CustomerComponent.prototype.selectCompany = function (company) {
        this.result = null;
    ...
    CustomerComponent.prototype.selectProduct = function (product) {
        this.buyingProduct = product;
        this.result = null;
    };
    CustomerComponent.prototype.confirmBuying = function (count) {
    ...
    CustomerComponent.prototype.setProducts = function (products) {
        this.products = products;
    };
    CustomerComponent.prototype.buyResult = function (result) {
        if (result) {
